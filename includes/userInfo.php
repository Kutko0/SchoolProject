...
if($actualInfo = getUserInfo($_SESSION['hash_id'])){
	...
	$class ='nezadane';
	$soc = 'nezadane';
	echo "<p style='color:rgb(64,64,200);font-weight:800;width:350px;margin:auto;margin-top:25px;
                margin-bottom:-90px;font-size:20px;text-align:center;'>
	                Este si nepridal<br> svoje info!</p>;";
}
?>
<div class="defCo">
    <div>
...
<div id='overlay'>
    <div class='overlayMainBox'>
        ...
        <div class='overlaySteps' id='actualInfo'>
            <p>Priezvisko : <span><?php echo $last_name;
?></span></p>
            <p>Meno : <span><?php echo $first_name;
?></span></p>
            <p>Odbor : <span><?php echo $odbor;
?></span></p>
            <p>Trieda : <span><?php echo $class;
?></span></p>
            <p>SOČ Kategoria : <span><?php echo $soc;
?></span></p>
        </div>
